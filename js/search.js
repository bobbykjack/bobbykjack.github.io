...
(function () {
    ...
    if (search_button) {
        ...
        // Load sitemap
        // NB If we're running on file: this needs to
        ...
        if (str) {
            ...
            for (var path in sitemap) {
                ...
                if (path.indexOf(str) !== -1) {
                    ...
                    page.hasOwnProperty("abstract") &&
                    page.abstract.toLowerCase().indexOf(str) !== -1
                ) {
                    matches.push(page);
                } else if (
                    page.hasOwnProperty("itemReviewed") &&
                    ...
                    page.hasOwnProperty("words") &&
                    page.words.includes(str)
                ) {
                    matches.push(page);
                }
            }
    ...
    function insertResults(results, original_query) {
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            if (results[i].hasOwnProperty("datePublished")) {
                ...
                small.appendChild(
                    document.createTextNode(results[i].datePublished),
                );
